...
sessionMange();
    ...
    {  
        ...
        {   $newName = $_POST['Name'];
          ...
          $sql= "UPDATE `user` SET `password` = '$newPass', `firstName` = '$newName', `lastName` = ' ', `telephone` = '$newPhone', `userEmail` = '$newEmail', `admin` = '$newType' WHERE `user`.`userId` = $id";
          $result= mysqli_query($conn,$sql);
          if(!$result)
          {
          echo "Error : ". $sql ;
                  ...
                  <form  id="addPro" name="AddPro" method="post" action="#" enctype="multipart/form-data">
                      ...
                      <span class="toolt" data-bs-parent="bottom" title="Enter User Name">
                       ...
                       <span class="toolt" data-bs-parent="bottom" title="Enter Your Password again">
                        ...
                        <!--Tooltip Admin-->
                        <span class="toolt" data-bs-parent="bottom" title="Enter User Type">
                          <div class="mb-4 input-group">
                              <span class="input-group-text">
                              ...
                              <div class="form-check form-check-inline ms-5 me-5 mt-2">
                                  ...
                                  <label class="form-check-label" for="typea">Admin</label>
                              </div> 
                         </div>
